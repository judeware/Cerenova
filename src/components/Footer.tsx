...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    company: [
      ...
      { label: "Email Us", href: "mailto:info@cerenova.com.au" },
    ],
  };
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed mb-6">
              Professional online psychology services for Australians. 
              Accessible, compassionate, and evidence-based mental health care.
            </p>
